...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2024 a las 22:46:21
...
INSERT INTO `producto` (`id_producto`, `id_proveedor`, `categoria`, `nombre`, `descripcion`, `precio`, `stock`) VALUES
(1, 1, 'Electrónica', 'Teléfono móvil', 'Teléfono móvil de última generación', 499.99, 50),
(2, 1, 'Electrodomésticos', 'Lavadora', 'Lavadora de carga frontal', 699.99, 30),
(3, 2, 'Ropa', 'Camiseta', 'Camiseta de algodón', 19.99, 100);
